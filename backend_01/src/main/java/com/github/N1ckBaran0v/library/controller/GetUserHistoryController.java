...
public class GetUserHistoryController extends AuthorizedController {
    private final BookService bookService;

    public GetUserHistoryController(@NotNull UserService userService, @NotNull BookService bookService) {
        super(userService);
    ...
    protected void _handle(@NotNull EndpointContext ctx, @NotNull String username) {
        try {
            ...
            ctx.setResponseBody(bookService.findUserHistory(target, user));
